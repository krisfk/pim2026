...
<div id="home-banner-carousel" class="carousel slide position-relative" data-bs-ride="carousel" style="overflow: hidden;">
  ...
  <div class="carousel-indicators" style="z-index: 11;">
    ...
    <button type="button" data-bs-target="#home-banner-carousel" data-bs-slide-to="3" aria-label="Slide 4"></button>
    <button type="button" data-bs-target="#home-banner-carousel" data-bs-slide-to="4" aria-label="Slide 5"></button>
    <button type="button" data-bs-target="#home-banner-carousel" data-bs-slide-to="5" aria-label="Slide 6"></button>
