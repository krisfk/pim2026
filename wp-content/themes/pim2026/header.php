				...
				<div class="d-flex align-items-center flex-grow-1" style="min-width:0;">
					<div class="d-flex align-items-center header-left" style="min-width:0;">
						<div class="site-logo">
							...
							<img class="header-logo-img-2 pe-1" src="<?php echo get_template_directory_uri(); ?>/assets/images/pim-logo-new.png" alt="">
					...
					<div class="header-search-desktop ms-3 d-none d-md-flex">
						<form role="search" method="get" class="d-flex" action="https://www.google.com/search" target="_blank" onsubmit="this.q.value = 'site:' + window.location.hostname + ' ' + this.searchinput.value;">
							<input type="hidden" name="q" value="">
							<input type="search" class="form-control form-control-sm" placeholder="Search…" name="searchinput" aria-label="Search">
